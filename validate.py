...
def main(argv: list[str] | None = None) -> None:
    ...
    if args.runner == "data_preflight":
        ...
        result = run_habitat_web_audit(cfg, allow_missing_data=args.allow_missing_data)
    elif args.runner == "habitat_web_scene_audit":
        ...
        result = run_pr2l_manifest_audit(cfg, allow_missing_data=args.allow_missing_data)
    ...
    elif args.runner == "hm3d_branch_structure":
