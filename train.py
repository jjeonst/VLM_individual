...
def main(argv: list[str] | None = None) -> None:
    ...
    if args.mode == "preflight":
        ...
        if cfg.data.trajectory_source == "habitat_web_replay":
            from topovlm_data.habitat_web import build_habitat_web_balanced_selection_manifest

            result = build_habitat_web_balanced_selection_manifest(cfg.data)
        elif cfg.data.trajectory_source == "objectnav_shortest_path":
            from topovlm_data.habitat_objectnav import build_objectnav_balanced_selection_manifest
        ...
        from topovlm_data.habitat_cache import build_habitat_graph_cache
        ...
        if cfg.data.trajectory_source == "habitat_web_replay":
            ...
            from topovlm_data.hm3d_objectnav_render import build_hm3d_objectnav_episode_manifest
